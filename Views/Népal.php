<body class="body">
    ...
    <section class="row Personnages-liés">
  ...
  <div class="link-container">
    <a href="http://localhost/PHP/Evaluation/Index.php?Ashe#">
        <div class="placeholder-circle">
          <img class="" alt="Image du personnage 1" src="image/8dc2a024c9b7d95c7141b2ef065590dbc8d9018d12ad15f76b01923986702228.png">
      </div>
    </a>
  </div>
  ...
  <div class="link-container">
    <a href="lien_vers_personnage_2.html">
        <div class="placeholder-circle">
          <img class="" alt="Image du personnage 2" src="image/4edf5ea6d58c449a2aeb619a3fda9fff36a069dfbe4da8bc5d8ec1c758ddb8dc (1).png">
      </div>
    </a>
  </div>
  ...
  <div class="link-container">
    <a href="lien_vers_personnage_3.html">
        <div class="placeholder-circle">
          <img class="" alt="Image du personnage 3" src="image/aecd8fa677f0093344fab7ccb7c37516c764df3f5ff339a5a845a030a27ba7e0.png">
        </div>
    </a>
  </div>
  ...
  <div class="link-container">
    <a href="lien_vers_personnage_4.html">
        <div class="placeholder-circle">
          <img class="" alt="Image du personnage 4" src="image/8dc2a024c9b7d95c7141b2ef065590dbc8d9018d12ad15f76b01923986702228.png">
        </div>
    </a>
  </div>
  ...
  <div class="link-container">
    <a href="lien_vers_personnage_5.html">
        <div class="placeholder-circle">
          <img class="" alt="Image du personnage 5" src="image/8dc2a024c9b7d95c7141b2ef065590dbc8d9018d12ad15f76b01923986702228.png">
      </div>
    </a>
  </div>
</section>
            ...
            <div class="row  mt-5 section_images">
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4 ">
                    <div class="card-image ">
                        <img class="" src="image/Cartes/Népal/Nepal_loading_screen.webp" alt="imgMaps 1">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4 ">
                    <div class="card-image">
                        <img class="img-fluid" src="image/Cartes/Népal/Nepal_Sanctum.webp" alt="imgMaps 2">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <div class="card-image">
                        <img class="img-fluid" src="image/Cartes/Népal/Nepal_Shrine.webp" alt="imgMaps 3">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <div class="card-image">
                        <img class="img-fluid" src="image/Cartes/Népal/Nepal_Village.webp" alt="imgMaps 4">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <div class="card-image">
                        <img class="" src="image/Cartes/Népal/Mon projet.jpg" alt="imgMaps 5">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <div class="card-image">
                        <img class="" src="image/Cartes/Népal/thiago-klafke-screenshot-16-12-23-10-54-34-000.jpg" alt="imgMaps 6">
