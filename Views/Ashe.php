        ...
        <div class="container-fluid col-sm-12 col-lg-6 px-5 mt-3 ">
            ...
            <div class="accordion-container">
                <button id="jeunesse-button" class="accordion active title">
                    <h1>Jeunesse</h1><i class="arrow down"></i>
                </button>
                ...
                <button id="deadlock-button" class="accordion title">
                    <h1>Deadlock Rebel</h1><i class="arrow down"></i>
                </button>
    ...
    <section class="images">
        <div class="container">
            <div class="row mt-5 section_images">
                <?php
                $images = [
                    'image/ashe-screenshot-001.1920.jpg',
                    'image/ashe-screenshot-002.webp',
                    'image/ashe-screenshot-003.webp',
                    'image/Overwatch-héros-Ashe.jpg',
                    'image/ASHE_THE_VIPER.jpg',
                    'image/15115-16655647477889-1920.webp'
                ];
                ?>
